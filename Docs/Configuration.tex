...
\item
  ...
  this setting should always be enabled when \texttt{KeySupport} is disabled (as in \texttt{Auto} mode),
  and should normally be disabled when \texttt{KeySupport} is enabled (as in \texttt{Auto} mode). On
